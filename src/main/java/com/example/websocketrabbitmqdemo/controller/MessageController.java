...
public class MessageController {
    ...
    @ApiOperation(value = "建立聊天室(store)", notes = "創建新的聊天室(從Store首頁點入)")
    @PostMapping(value = "/createChatroom", params = {"userId", "storeId"})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "success", response = CreateChatroomResponse.class)})
    ...
    public ResponseInfo createChatroom(@ApiParam(value = "user的Id") @RequestParam(value = "userId") String userId,
                                       ...
                                       @ApiParam(value = "Bu類型 (customer, support)") @RequestParam(value = "buType") String buType) throws MqttException {
        return dialogueService.createChatroom(userId, storeId, buType);
    }

    @ApiOperation(value = "建立聊天室(sku)", notes = "創建新的聊天室(從某個SKU的PDP)")
    ...
    public ResponseInfo createChatroom(
            ...
            @ApiParam(value = "Bu類型 (customer, support)") @RequestParam(value = "buType") String buType) throws MqttException {
        return dialogueService.createChatroom(userId, storeId, skuId, buType);
    }

    @ApiOperation(value = "建立聊天室(order, sku)", notes = "創建新的聊天室(從訂單中的特定SKU)")
    ...
    public ResponseInfo createChatroom(
            ...
            @ApiParam(value = "store的Id") @RequestParam(value = "storeId") String storeId,
            @ApiParam(value = "sku的Id") @RequestParam(value = "skuId") String skuId,
            @ApiParam(value = "order的Id") @RequestParam(value = "orderId") String orderId,
            @ApiParam(value = "Bu類型 (customer, support)") @RequestParam(value = "buType") String buType) throws MqttException {
        return dialogueService.createChatroom(userId, storeId, skuId, orderId, buType);
    }
    ...
    public ResponseInfo getMessageList(
            @ApiParam(value = "user的Id") @RequestParam(value = "userId") String userId,
            @ApiParam(value = "BU類型(customer, support)") @RequestParam(value = "BuType") String BuType,
            @ApiParam(value = "狀態(handling, pending, completed)") @RequestParam(value = "status") String status,
        ...
        return dialogueService.getDialogueList(userId, BuType, status, startIndex, size);
    }
